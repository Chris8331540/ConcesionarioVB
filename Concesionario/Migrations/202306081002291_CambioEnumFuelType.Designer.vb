...
Namespace Migrations
    ...
    Public NotInheritable Partial Class CambioEnumFuelType
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CambioEnumFuelType))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202306081002291_CambioEnumFuelType"
            End Get
        End Property
