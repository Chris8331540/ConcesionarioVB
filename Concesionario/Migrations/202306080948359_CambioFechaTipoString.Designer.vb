...
Namespace Migrations
    ...
    Public NotInheritable Partial Class CambioFechaTipoString
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(CambioFechaTipoString))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202306080948359_CambioFechaTipoString"
            End Get
        End Property
